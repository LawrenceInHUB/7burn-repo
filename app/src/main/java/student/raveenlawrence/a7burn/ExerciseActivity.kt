...
import student.raveenlawrence.a7burn.databinding.ActivityExcerciseBinding
import student.raveenlawrence.a7burn.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try{
            val soundURI = Uri.parse("android.resource://student.raveenlawrence.a7burn/"+ R.raw.press_start)
        ...
        exerciseTimer = object: CountDownTimer(exerciseTimerDuration*5000,1000){
            ...
            override fun onFinish() {
                ...
                if(currentExercisePosition <exerciseList?.size!! -1){
                    ...
                    exerciseList!![currentExercisePosition].seIsCompleted(true)
                    exerciseAdapter!!.notifyDataSetChanged()
                    setupRestView()
                }else{
                    finish()
