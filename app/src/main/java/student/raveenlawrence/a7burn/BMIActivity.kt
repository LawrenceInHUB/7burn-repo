...
import student.raveenlawrence.a7burn.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private fun displayBMIResult(bmi:Float){
        ...
        if(bmi.compareTo(15f) <= 0){
            ...
            bmiDescription = "Oops! You really need to take better care of yourself! Eat more foods"
    ...
    private fun calculateUnits(){
        if (currentVisibleView == METRIC_UNITS_VIEW){
            ...
            if (validateUsUnits()){
                ...
                val usUnitHeightValueInch: String = binding?.etUsMetricUnitHeightFeet?.text.toString()
